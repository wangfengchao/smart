...
//    private String dbUrl = "jdbc:mysql://172.16.13.1:3306/fireeye?characterEncoding=UTF8";      // 数据 URL
    private String dbUrl = "jdbc:mysql://10.0.18.116:3306/fireeye?characterEncoding=UTF8";      // 数据 URL
    ...
    private int maxConnections = 1;         // 连接池最大的大小
     ...
     */
    public MySqlConnectionPool(String jdbcDriver, String dbUrl, String dbUsername, String dbPassword) {
